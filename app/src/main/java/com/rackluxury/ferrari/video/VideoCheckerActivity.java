...
import com.rackluxury.ferrari.activities.HomeActivity;
...
public class VideoCheckerActivity extends AppCompatActivity implements PurchasesUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, com.rackluxury.ferrari.video.BroadcastServiceVideo.class);
        startService(intent);
    ...
    protected void onResume(){
        super.onResume();
        registerReceiver(broadcastReciever,new IntentFilter(com.rackluxury.ferrari.video.BroadcastServiceVideo.COUNTDOWN_BR));

    }
    @Override
    protected void onDestroy(){
        stopService(new Intent(this, com.rackluxury.ferrari.video.BroadcastServiceVideo.class));
        super.onDestroy();
    }
        ...
        try {
            if (purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
                if (purchase.getSku().equals(categories)) {
                    ...
                    Uri uri1 = Uri.parse("android.resource://com.rackluxury.ferrari/drawable/img_video_checker");
