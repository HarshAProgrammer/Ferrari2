package com.rackluxury.ferrari.youtube;
...
public class YouTubeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (com.rackluxury.ferrari.youtube.ApiKey.YOUTUBE_API_KEY.startsWith("YOUR_API_KEY")) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, com.rackluxury.ferrari.youtube.YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, YOUTUBE_PLAYLISTS))
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_recyclerview) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.container, com.rackluxury.ferrari.youtube.YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, YOUTUBE_PLAYLISTS))
                    .commit();
            return true;
        }
